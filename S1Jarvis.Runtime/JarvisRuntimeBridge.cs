...
namespace S1Jarvis.Runtime
{
    public static class JarvisRuntimeBridge
    {
        ...
        public static string ActivateVerilicAll()
        {
            ...
            try
            {
                ...
                foreach (string productCode in VerilicActivationProducts)
                {
                    ...
                    messages.Add(productCode +
                        (result.WasAlreadyCompleted ? ": already_completed" : ": activated"));
                }
            ...
            {
                const string message = "Verilic activation failed: activation_configuration_invalid";
                MessageBox.Show(message, "Verilic licensing", MessageBoxButton.OK, MessageBoxImage.Error);
                return message;
            }
        }
        ...
        private static string ShowActivationSummary(IEnumerable<string> messages, bool isError)
        {
        ...
        private static string FormatReadiness(string label, VerilicProductReadiness readiness)
        {
            if (readiness == null)
